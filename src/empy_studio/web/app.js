...
const t = {
  fa: {
    ...
    newProject: "پروژه‌ی دیگر", startHere: "از اینجا شروع کنید", projectStartHint: "برای شروع یک پروژه انتخاب کنید یا فایل جدید وارد کنید.", reimportProject: "ورود دوبارهٔ پروژه", projectUnavailable: "مسیر این پروژه دیگر وجود ندارد؛ پوشه یا ZIP را دوباره وارد کنید.", noTask: "هنوز تیکتی ثبت نشده است.", engine: "وضعیت Codex",
  ...
  en: {
    ...
    newProject: "Another project", startHere: "Start here", projectStartHint: "Choose a project or import a new file to get started.", reimportProject: "Re-import project", projectUnavailable: "This project's path is no longer available; choose its folder or ZIP again.", noTask: "No tickets have been registered.", engine: "Codex status",
...
function projectList() {
  ...
  if (!projects.length) {
    return `<p class="project-empty-hint" style="color:#2f7d5a;font-size:13px;line-height:1.8;margin:8px 0 0">${text().projectStartHint}</p>`;
  }
